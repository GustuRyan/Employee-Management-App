...
import 'package:hr_360/presentation/module/menu/traning/widget/form_training_add_plan.dart';

import '../../../../core/style/style.dart';
import '../../../widget/customs/custom_form_bottom_nav.dart';

class TrainingAddPlanScreen extends GetResponsiveView<TrainingAddPlanController>{
  TrainingAddPlanScreen({super.key});
